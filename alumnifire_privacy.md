...
through the Privacy Policy to make sure we're on the same page. While we're on
the subject, if you haven't read our [Terms of Service](/terms) yet, you should.
It's our contract with you that defines how we work together. It also defines a
bunch of helpful key words that make it easier to write legal documents. Those
words mean the same thing here in the Privacy Policy that they do in the Terms,
...
address associated with your Alumnifire Account or with a conspicuous notice on the
...
can email us at [feedback@alumnifire.com](mailto:feedback@alumnifire.com) and we
...
* basic information like your name, phone number, email address, mailing address, or
  profile picture;
...
Members with whom you communicate, and specific times that you access the Service.
While we don't consider this information Personal Information, we may combine it
with your Personal Information to serve you better. For example, we may store the
...
use the Service by logging into a SN Account (for example, your LinkedIn,
or Facebook accounts). If you do, you will be giving us access to some
...
to that SN). We will use that Personal Information to create your Alumnifire Account,
...
* We may check to see if any friends or connections of yours on a SN are also
  Alumnifire Members. If we find a match, we can connect you with those friends
  automatically.
* We may use friend lists from a SN so that you can choose to share your Alumnifire
  Account profile page with those friends using messages specific to that SN service.
...
Privacy Policy, or other relevant Content. We may use your email address,
mobile phone number, or Twitter handle associated with your Personal Information
...
list of your SN friends or connections who are also Members of Alumnifire, SNs you
have connected to your Alumnifire Account, a bio, free or paid products and services
you offer, job postings, and education history, if applicable (all such information
comprises your profile information). Profile information you provide may be publicly
visible to all users of the Service and consequently should reflect how much you want
others to know about you. Be careful and protect information you consider sensitive
...
[feedback@alumnifire.com](mailto:feedback@alumnifire.com) to request that we remove
...
profile directly via the Site or App. If you want your Alumnifire Account
deactivated, we'll hold back our tears, and you can email us at
[feedback@alumnifire.com](mailto:feedback@alumnifire.com). We will deactivate your
account if we don't have a legal obligation or legitimate business reason to
retain the information contained in your Alumnifire Account. In either case, keep in
...
credit card or banking information, your Alumnifire Account ID, login password, or
...
countries. As a result, your information as shared with Alumnifire and our partners
