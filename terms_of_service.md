...
In order either to create a advicedrop Account using your credentials with a SN
...
Also associated with an Exchange is the **"Service Fee"** collected by advicedrop
